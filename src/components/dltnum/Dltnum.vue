<template>
    <div class="checknum">
        <div class="nav clearfix">{{title}}
            <span class="fl some1"  onClick="javascript :history.back(-1);"><img src="./images/backicon.png"/></span>

            <el-dropdown class="fr some" @command="handleCommand" trigger="click">
